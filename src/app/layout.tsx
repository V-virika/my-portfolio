...
export const metadata: Metadata = {
  ...
  description:
    'Portfolio of Virika Olivia Soans - B.Tech in CSE (Data Science) graduate. Specializing in Vision Transformers, Deep Learning, Financial AI, and Modern Web Development.',
  keywords: [
    'Virika Olivia Soans',
    'Data Science',
    'Software Engineer',
